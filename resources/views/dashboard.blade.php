                ...
                <div class="col-span-12">
                    ...
                    <div class="tab-content box box--stacked mt-3.5">
                        <div data-transition="" data-selector=".active"
                             ...
                             class="tab-pane active flex flex-col gap-2 p-1.5 leading-relaxed xl:flex-row visible opacity-100"
                             data-state="enter" style="width:100%;">
                                    ...
                                    <div class="relative col-span-5 flex-1 overflow-hidden rounded-[0.6rem] {{$loop->iteration==1?'border-0 border-slate-200/60 bg-slate-50 bg-gradient-to-b from-theme-2/90 to-theme-1/[0.85] p-5 before:absolute before:right-0 before:top-0 before:-mr-[62%] before:h-[130%] before:w-full before:rotate-45 before:bg-gradient-to-b before:from-black/[0.15] before:to-transparent': 'border bg-slate-50/50'}}  p-5 sm:col-span-3 xl:col-span-1">
                                        <div
                                            ...
                                            <i data-tw-merge="" data-lucide="{{$data['icon']}}"
                                               class="lucide lucide-database stroke-[1] h-6 w-6 fill-white/10 text-{{$loop->iteration==1?'white':'primary'}}"></i>
                                        </div>
                                        <div class="mt-12 flex items-center">
                                            <div
                                                class="text-2xl font-medium {{$loop->iteration==1?'text-white':''}}">{{$data['value']}}</div>
                                            <div
                                                class="ml-3.5 flex items-center rounded-full border border-{{$data['growth']?'success':'danger'}}/50 bg-{{$data['growth']?'success':'danger'}}/70 py-[2px] pl-[7px] pr-1 text-xs font-medium text-white/90">
                                                {{$data['percentage']}}
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                     viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                     stroke-width="2"
                                                     stroke-linecap="round" stroke-linejoin="round"
                                                     data-lucide="{{$data['growth']?'chevron-up':'chevron-down'}}"
                                                     class="lucide lucide-chevron-up ml-px h-4 w-4 stroke-[1.5]">
                                                    <path d="m6 9 6 6 6-6"></path>
                                                </svg>
                                            </div>
                                        </div>
                                        <div
                                            class="mt-1 text-base {{$loop->iteration==1?'text-white/70':'text-slate-500'}}">
                                            {{$data['text']}}
                                        </div>
                                ...
                                <div class="box box--stacked relative p-5">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <i data-tw-merge="" data-lucide="heart"
                                        ...
                                        <div class="ml-auto flex">
                                            <div class="image-fit zoom-in h-8 w-8">
                                                <img
                                                    ...
                                                    src="{{asset('assets/images/products/1.jpg')}}" alt="Top Products">
                                            </div>
                                            <div class="image-fit zoom-in -ml-3 h-8 w-8">
                                                <img
                                                    class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]"
                                                    src="{{asset('assets/images/products/3.jpg')}}" alt="Top Products">
                                            </div>
                                            <div class="image-fit zoom-in -ml-3 h-8 w-8">
                                                <img
                                                    class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]"
                                                    src="{{asset('assets/images/products/5.jpeg')}}" alt="Top Products">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-11">
                                ...
                                <div class="box box--stacked relative p-5">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <i data-tw-merge="" data-lucide="droplet"
                                               class="stroke-[1] w-5 h-5 group-[.primary]:text-primary group-[.primary]:fill-primary/10 group-[.success]:text-success group-[.success]:fill-success/10"></i>
                                        </div>
                                        <div class="ml-auto flex">
                                            <div class="image-fit zoom-in h-8 w-8">
                                            ...
                                            <div class="image-fit zoom-in -ml-3 h-8 w-8">
                                                <img
                                                    class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]"
                                                    src="{{asset('assets/images/products/7.jpg')}}"
                                                    alt="Tailwise - Admin Dashboard Template">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="px-2.5 pb-3 col-span-4 sm:col-span-2 xl:col-span-1">
                                <div class="box box--stacked relative p-5">
                                    <div class="flex items-center">
                                        <div
                                            class="group flex items-center justify-center w-10 h-10 border rounded-full [&.primary]:border-primary/10 [&.primary]:bg-primary/10 [&.success]:border-success/10 [&.success]:bg-success/10 primary">
                                            <i data-tw-merge="" data-lucide="battery-charging"
                                               class="stroke-[1] w-5 h-5 group-[.primary]:text-primary group-[.primary]:fill-primary/10 group-[.success]:text-success group-[.success]:fill-success/10"></i>
                                        </div>
                                        <div class="ml-auto flex">
                                            <div class="image-fit zoom-in h-8 w-8">
                                            ...
                                            <div class="image-fit zoom-in -ml-3 h-8 w-8">
                                                <img
                                                    class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]"
                                                    src="{{asset('assets/images/products/5.jpeg')}}"
                                                    alt="Tailwise - Admin Dashboard Template">
                                            </div>
                                            <div class="image-fit zoom-in -ml-3 h-8 w-8">
                                                <img
                            ...
                            <div class="px-2.5 pb-3 col-span-4 sm:col-span-2 xl:col-span-1">
                                <div class="box box--stacked relative p-5">
                                    <div class="flex items-center">
                                        <div
                                            class="group flex items-center justify-center w-10 h-10 border rounded-full [&.primary]:border-primary/10 [&.primary]:bg-primary/10 [&.success]:border-success/10 [&.success]:bg-success/10 primary">
                                            <i data-tw-merge="" data-lucide="alert-triangle"
                                               class="stroke-[1] w-5 h-5 group-[.primary]:text-primary group-[.primary]:fill-primary/10 group-[.success]:text-success group-[.success]:fill-success/10"></i>
                                        </div>
                                        <div class="ml-auto flex">
                                            <div class="image-fit zoom-in h-8 w-8">
                        ...
                        <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                            <button
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     ...
                                     stroke-linejoin="round" data-lucide="file-bar-chart2"
                                     class="lucide lucide-file-bar-chart2 mr-2 h-4 w-4 stroke-[1.3]">
                                    <path
                                ...
                                <div>
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="Search transactions..."
                                               class="pl-[40px] rounded-l-md transition duration-200 ease-in-out w-full text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0"
                                        >
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="flex items-center">
                                                <div class="image-fit zoom-in h-9 w-9">
                                                    <img data-placement="top"
                                                         src="{{asset('assets/images/users/user4.jpeg')}}"
                                                         alt="Tailwise - Admin Dashboard Template"
                                    ...
                                    <tr class="[&amp;_td]:last:border-b-0">
                                        ...
                                        <td class="px-5 border-[1px] border-slate-300 w-44  py-4 dark:bg-darkmode-600">
                                            <div class="flex items-center">
                                                <div class="image-fit zoom-in h-9 w-9">
                                                    <img data-placement="top"
                                                         src="{{asset('assets/images/users/user2.jpeg')}}"
                                                         alt="Tailwise - Admin Dashboard Template"
                                                         class="tooltip cursor-pointer rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]">
                                                </div>
                                                <div class="ml-3.5">
