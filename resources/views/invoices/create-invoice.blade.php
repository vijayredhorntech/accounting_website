                        ...
                        <div class="box box--stacked flex flex-col">
                            ...
                            <div class="px-7 py-2">
                                <div class=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-2">
                                    <div class="lg:col-span-2 md:col-span-1 col-span-1 mb-2 w-full inline-block sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 lg:border-r-[1px] md:border-r-[1px] border-r-[0px] lg:border-b-[0px] md:border-b-[0px] border-b-[1px] border-gray-200">
                                        <div class="text-left">
                                    ...
                                    <div class="grid grid-cols-2 gap-2 xl:mt-0 ">
                                        <div class="flex flex-col ">
                                            <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80">
                                                <div class="font-normal">{{ucfirst($type)}} Invoice Number</div>
                                            </div>
                                        ...
                                        <div class="flex flex-col ">
                                            <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80">
                                                <div class="font-normal">{{ucfirst($type)}} Invoice Date</div>
                                            </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div id="changePartyDiv" data-tw-merge
                                             ...
                                             class="hidden transition duration-200 border shadow-sm inline-flex items-center justify-center rounded-md font-medium cursor-pointer focus:ring-0 focus:ring-opacity-0 focus-visible:outline-none text-xs py-1.5 px-4 border-primary text-primary"
                                        >
                                            Change Party
                                        </div>
                                    </div>
                                ...
                                <div id="shipToDiv" class=" flex flex-col p-2  hidden">
                                    ...
                                    <div class=" w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-1 ">
                                        <div class="flex flex-col ">
                                            ...
                                            <input type="text" placeholder="Company name....." value="Other Company Name"
                                                   class="rounded-l-md transition duration-200 ease-in-out w-full text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0"
                                            >
                                        </div>
                                        <div class="flex flex-col ">
                                        ...
                                        <td class="px-5  dark:border-darkmode-300 border-[1px] border-slate-400 py-4 dark:bg-darkmode-600 flex flex-col">
                                            ...
                                            <div class="flex gap-1 border-[0px]">
                                                ...
                                                <input type="number" placeholder="%" value="2"
                                                       class="w-12 py-0.5 rounded-tl-md rounded-br-md transition duration-200 ease-in-out  text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0">
                                                    ...
                                                    >
                                                        ...
                                                        <div class="col-span-12 sm:col-span-12">
                                                            ...
                                                            <select
                                                                ...
                                                                class="w-full rounded-tl-md rounded-br-md transition duration-200 ease-in-out  text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0"
                                                            >
                                                ...
                                                "
                                                    ...
                                                    <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2">
                                                        <input type="text" placeholder="Charges Name ....."
                                                               class="w-full rounded-l-md transition duration-200 ease-in-out  text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0">

                                                        <input type="number" placeholder="Amount (₹) ....."
                                                               class="w-full rounded-r-md transition duration-200 ease-in-out  text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0">
                                                ...
                                                "
                                                    ...
                                                    <div class="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-2">
                                                        ...
                                                        <input type="number" placeholder="Discount (%)....."
                                                               class="w-full transition duration-200 ease-in-out  text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0">
                                    ...
                                    <div class=" py-4 border-b-[1px] border-gray-200 flex flex-col gap-4">
                                        <div class=" w-full flex justify-between lg:flex-row md:flex-row flex-col gap-2 ">
                                            ...
                                            <div
                                                ...
                                                <select
                                                    class="lg:w-[100px] md:w-[100px] w-full rounded-l-md py-1 transition duration-200 ease-in-out  text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0">
                                                    <option value="add">+ Add</option>
                                                    <option value="reduce">- Reduce</option>
                                                </select>
                                                <input type="number" placeholder="Amount (₹) ....."
                                                       class="lg:w-[100px] md:w-[100px] w-full rounded-r-md py-1 transition duration-200 ease-in-out  text-sm border-slate-300 focus:border-slate-400 shadow-sm  placeholder:text-slate-400/90 focus:ring-0 focus:ring-opacity-0">
